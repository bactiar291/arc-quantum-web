  ...
  return (
    <button
      className={clsx(
        ...
        variant === 'cyan' && 'bg-quantum-cyan text-black shadow-[4px_4px_0_#F1DA63]',
        variant === 'red' && 'bg-quantum-red text-white shadow-[4px_4px_0_#F1DA63]',
        variant === 'ghost' && 'bg-black text-white shadow-[4px_4px_0_#F1DA63]',
        className
      )}
      {...props}
    >
