  ...
  return (
    <button
      className={clsx(
        ...
        variant === 'cyan' && 'bg-quantum-cyan text-black shadow-[4px_4px_0_#FFE500]',
        variant === 'red' && 'bg-quantum-red text-white shadow-[4px_4px_0_#FFE500]',
        variant === 'ghost' && 'bg-black text-white shadow-[4px_4px_0_#FFE500]',
        className
      )}
      {...props}
    >
