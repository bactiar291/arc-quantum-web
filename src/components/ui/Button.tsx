  ...
  return (
    <button
      className={clsx(
        ...
        variant === 'cyan' && 'bg-quantum-cyan text-black shadow-[4px_4px_0_#D8C95C]',
        variant === 'red' && 'bg-quantum-red text-white shadow-[4px_4px_0_#D8C95C]',
        variant === 'ghost' && 'bg-black text-white shadow-[4px_4px_0_#D8C95C]',
        className
      )}
      {...props}
    >
